...
export function DiffModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-10 w-full max-w-5xl max-h-[90vh] bg-white dark:bg-gray-900 rounded-lg shadow-xl flex flex-col overflow-hidden">
        {/* Header */}
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {stats.created > 0 && (
                <span className="ml-2 text-emerald-600">
                  <Plus className="inline w-3 h-3" /> {stats.created} created
                </span>
              )}
              {stats.modified > 0 && (
              ...
              {stats.deleted > 0 && (
                <span className="ml-2 text-red-600">
                  <Minus className="inline w-3 h-3" /> {stats.deleted} deleted
                </span>
              )}
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Button onClick={fetchChanges} variant="outline" className="mt-4">
                Try Again
              </Button>
            </div>
          ) : changes.length === 0 ? (
