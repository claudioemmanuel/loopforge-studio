    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed inset-0 z-50 flex items-center justify-center outline-none">
          {/* Modal */}
          <div className="relative z-10 w-full max-w-lg bg-white dark:bg-gray-900 rounded-lg shadow-xl mx-4">
            {/* Header */}
                  ...
                  <div className="flex items-start gap-3 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-amber-700 dark:text-amber-300 mt-1">
                        A new revert commit will be created. This cannot be
                        undone easily.
                      </p>
                    </div>
                  </div>
