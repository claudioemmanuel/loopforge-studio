/**
 * Analytics Query Repository (Infrastructure Layer)
 *
 * Manages all read-only analytics queries, separating them from the application service.
 * This improves testability by allowing mock repositories in unit tests.
 */
